...
from tubecli.data.extensions_external.pod_studio.studio_routes import _batch_tts_worker_gemini
import asyncio
...
async def test():
    ...
    from tubecli.data.extensions_external.pod_studio.studio_routes import _tts_tasks
